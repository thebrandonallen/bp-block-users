...
if ( class_exists( 'WP_Users_List_Table' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class BPBU_Users_List_Table extends WP_Users_List_Table {
		...
		public function get_columns() {
			...
			/**
			 * Filters the single site blocked users columns.
			 *
			 * @since 1.0.0
			 *
			 * @param array $columns Array of columns to display.
			 */
			return apply_filters( 'bpbu_blocked_users_columns', array(
		 ...
		 * As we're dealing with blocked users, we don't need this.
		 *
		 * @since 1.0.0
		 *
		...
		protected function column_username( $user = null ) {
			...
			/**
			 * Filters the single site row actions for each user in list.
			 *
			 * @since 1.0.0
			 *
			 ...
			 * @param WP_User $user    The blocked user data object.
			 */
			$actions = apply_filters( 'bpbu_users_row_actions', $actions, $user );
